...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (contactForm) {
        ...
        function ucitajUsluge() {
            ...
            fetch(API_BASE + "?action=getUsluge")
                .then(res => res.json())
                .then(usluge => {
                ...
                .catch(() => {
                    ...
                    // fallback ako backend nije jos povezan - ista lista kao seed-podaci.gs
                    const podrazumevaneUsluge = [
                        { id: 1, naziv: "Osnovna nega lica", kategorija: "nega-lica", cena: 2500 },
                        { id: 2, naziv: "Dubinska nega", kategorija: "nega-lica", cena: 3500 },
                        { id: 3, naziv: "Hidratacija", kategorija: "nega-lica", cena: 2800 },
                        { id: 4, naziv: "Klasičan manikir", kategorija: "nokti", cena: 1500 },
                        { id: 5, naziv: "Gel lak", kategorija: "nokti", cena: 2200 },
                        { id: 6, naziv: "Korekcija", kategorija: "nokti", cena: 1200 },
                        { id: 7, naziv: "Nail art", kategorija: "nokti", cena: 2500 },
                        { id: 8, naziv: "Klasičan pedikir", kategorija: "pedikir", cena: 2000 },
                        { id: 9, naziv: "Pedikir + lak", kategorija: "pedikir", cena: 2500 },
                        { id: 10, naziv: "Pedikir + gel lak", kategorija: "pedikir", cena: 3200 },
                        { id: 11, naziv: "Nega stopala", kategorija: "pedikir", cena: 1800 },
                        { id: 12, naziv: "Oblikovanje obrva", kategorija: "obrve-trepavice", cena: 900 },
                        { id: 13, naziv: "Farbanje obrva", kategorija: "obrve-trepavice", cena: 1200 },
                        { id: 14, naziv: "Lash lift", kategorija: "obrve-trepavice", cena: 3000 },
                        { id: 15, naziv: "Farbanje trepavica", kategorija: "obrve-trepavice", cena: 1000 },
                        { id: 16, naziv: "Obrve + trepavice", kategorija: "obrve-trepavice", cena: 1800 },
                    ];
        ...
        function ucitajSlobodneTermine() {
            ...
            fetch(API_BASE + "?action=getSlobodniTermini&usluga_id=" + uslugaId + "&datum=" + datum)
                .then(res => res.json())
                .then(termini => {
                ...
                .catch(() => {
                    ...
                    // fallback ako backend nije jos povezan - podrazumevana vremena
                    // (Pon-Pet 9-19h, na pola sata), da forma ne izgleda prazna dok testiras
                    timeSlotsContainer.innerHTML = "";
                    for (let sat = 9; sat <= 18; sat++) {
                        ['00', '30'].forEach(minut => {
                            const vreme = String(sat).padStart(2, '0') + ':' + minut;
                            const dugme = document.createElement("button");
                            dugme.type = "button";
                            dugme.className = "time-slot";
                            dugme.textContent = vreme;
                            dugme.dataset.vreme = vreme;
                            dugme.dataset.zaposleniId = "1";
                            ...
                            dugme.addEventListener("click", () => {
                                timeSlotsContainer
                                    ...
                                    .forEach(el => el.classList.remove("selected"));
                                dugme.classList.add("selected");
                                selectedTimeInput.value = vreme;
                                selectedEmployeeInput.value = "1";
                            });
